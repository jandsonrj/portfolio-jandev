export const content = {
  ...
  en: {
    ...
    about: {
      ...
      p1: 'Curious about technology from an early age, I found in software development a way to turn ideas into products. Today, at 27 and working as a Software Engineer at benext.ai, I combine my passion for frontend with the power of Artificial Intelligence to solve complex real-world problems.',
